...
class FragmentDiterimaAdapter(
    private val pengaduan: List<PengaduanResponse.Pengaduan>,
    private val listener: OnAdapterListener
) : RecyclerView.Adapter<FragmentDiterimaAdapter.ViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): FragmentDiterimaAdapter.ViewHolder {
        return ViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.activity_dashboard_mahasiswa_adapter_diterima, parent, false)
        )
    }

    override fun onBindViewHolder(holder: FragmentDiterimaAdapter.ViewHolder, position: Int) {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view){
        val imagePengaduan = view.findViewById<ImageView>(R.id.image_preview_adapter_diterima)
        val isiPengaduan = view.findViewById<TextView>(R.id.text_adapter_diterima)
        val fabDetail = view.findViewById<FloatingActionButton>(R.id.fab_adapter_detail_diterima)
    }
